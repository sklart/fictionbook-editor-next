...
& (Join-Path $repoRoot "tools\tests\test-mainframe-idle-profiler-contract.ps1")
& (Join-Path $repoRoot "tools\tests\test-fbe-spellcheck-scroll-contract.ps1")
& (Join-Path $repoRoot "tools\tests\test-description-idle-contract.ps1")
...
& (Join-Path $repoRoot "tools\tests\test-fbe-document-file-dialog-boundary.ps1")
...
& (Join-Path $repoRoot "tools\tests\test-fbe-failed-open-runtime.ps1") -FbeExe (Join-Path $outputDir "FBE.exe")
& (Join-Path $repoRoot "tools\tests\test-fbe-malformed-source-fallback-runtime.ps1") -FbeExe (Join-Path $outputDir "FBE.exe")
& (Join-Path $repoRoot "tools\tests\test-fbe-document-lifecycle-runtime.ps1") -FbeExe (Join-Path $outputDir "FBE.exe")
...
& (Join-Path $repoRoot "tools\tests\test-fbe-body-structural-editor-boundary.ps1")
& (Join-Path $repoRoot "tools\tests\test-fbe-split-container-production.ps1") -FbeExe (Join-Path $outputDir "FBE.exe")
...
& (Join-Path $repoRoot "tools\tests\test-fbe-link-navigation-boundary.ps1")
& (Join-Path $repoRoot "tools\tests\test-fbe-link-navigation-runtime.ps1") -FbeExe (Join-Path $outputDir "FBE.exe")
