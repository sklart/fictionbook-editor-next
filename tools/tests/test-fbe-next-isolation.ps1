...
Assert-Contains $startupTrace 'FBE_NEXT_STARTUP_TRACE' 'Переменная startup trace Next'
Assert-Contains $startupTrace 'FBE Next' 'Каталог startup trace Next'
...
Assert-Contains $installer 'Software\FBETeam\FictionBook Editor Next\Plugins' 'Проверка регистрации плагинов установщиком'
