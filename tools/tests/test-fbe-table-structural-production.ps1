...
#>
[CmdletBinding()]
param([string]$FbeExe = (Join-Path $PSScriptRoot '..\..\out\Release\FBE.exe'), [int]$TimeoutSeconds = 180, [switch]$KeepArtifacts, [switch]$RouteThroughFrame, [string]$Target, [string]$Operation, [string]$SecondOperation, [string]$FixtureId, [string]$RuntimeStyle)
