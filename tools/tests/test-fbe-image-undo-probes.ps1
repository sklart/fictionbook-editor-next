...
param(
    ...
    [ValidateSet('binary', 'binary-fill', 'image', 'image-start', 'image-end', 'image-middle', 'image-legacy-exact-start', 'image-legacy-exact-noreturn-start', 'image-hold-start', 'image-clear-start', 'image-discard-start', 'image-inspect-release-start', 'image-inline', 'image-no-url', 'plain-block', 'plain-block-after', 'plain-block-auto', 'plain-block-markup', 'plain-block-custom', 'plain-block-adjacent-html', 'plain-block-adjacent-html-after', 'plain-block-adjacent-html-image', 'plain-block-adjacent-html-image-after', 'plain-block-range-html', 'plain-block-range-html-after', 'fbe285-start', 'fbe285-end', 'fbe285-middle', 'fbe285-return-hold-start', 'fbe285-dispatch-full-start', 'fbe285-dispatch-full-invoke2-start', 'fbe285-dispatch-dom-start', 'fbe285-exec-full-start', 'fbe285-exec-split-start', 'call-insimage-empty', 'compile-mainjs', 'compile-inline', 'compile-dynamic-load', 'compile-dynamic-documentcomplete', 'compile-static-wrapper', 'fbe285-bisect-full', 'fbe285-bisect-no-normalize', 'fbe285-bisect-no-whole', 'fbe285-bisect-no-move-to-element', 'fbe285-bisect-no-duplicate', 'fbe285-bisect-no-set-endpoint', 'fbe285-bisect-no-text-read', 'fbe285-bisect-no-whole-no-normalize', 'fbe285-bisect-no-whole-unconditional', 'fbe285-bisect-no-whole-if-true', 'fbe285-bisect-compile-label-unconditional', 'fbe285-bisect-minimal', 'fbe285-bisect-compile-exact', 'body-cache-cached', 'body-cache-fresh', 'body-cache-production-undo')]
    [string]$Probe = 'binary',
...
"@ | Set-Content -LiteralPath $fixturePath -Encoding utf8
    ...
    if ($UndoRedoCycles -gt 0 -and ((($Probe -match '^image') -and $Probe -ne 'image-no-url') -or $Probe -match '^plain-block' -or $Probe -match '^fbe285' -or $Probe -match '^compile-')) { if ($phases -notmatch "redo-complete-$UndoRedoCycles") { throw "${Probe}: Redo не завершился. Фазы: $phases" } }
