...
'@ | Set-Content -LiteralPath $sourcePath -Encoding utf8
    & cl.exe /nologo /EHsc /std:c++17 /utf-8 /MT "/I$repoRoot\src\fbe\source" "/Fo:$temporary\\" "/Fe:$exePath" $sourcePath (Join-Path $repoRoot 'src\fbe\source\Fb2SourceStructuralContext.cpp')
