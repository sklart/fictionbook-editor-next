...
foreach ($name in @('LiteralSearch.cpp', 'LiteralSearch.h', 'RegexBackend.cpp', 'RegexBackend.h', 'RegexBackendPcre2.cpp', 'RegexPcre2CodeCache.h', 'RegexPcre2MatchLoop.h', 'SearchResults.cpp', 'SearchResults.h', 'SearchSession.cpp', 'SearchSession.h', 'SearchTextSnapshot.cpp', 'SearchTextSnapshot.h', 'SearchTypes.h')) {
...
foreach ($source in @('LiteralSearch.cpp', 'LiteralSearch.h', 'RegexBackend.cpp', 'RegexBackendPcre2.cpp', 'SearchResults.cpp', 'SearchResults.h', 'SearchSession.cpp', 'SearchSession.h', 'SearchTextSnapshot.cpp', 'SearchTextSnapshot.h', 'SearchTypes.h')) {
