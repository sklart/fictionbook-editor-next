...
& $compiler /nologo /EHsc /std:c++17 /utf-8 /DUNICODE /D_UNICODE /MD /W3 "/I$repoRoot\src\export-html" "/I$repoRoot\third_party" "/Fo:$out\\" $source (Join-Path $repoRoot 'src\export-html\Utils.cpp') "/Fe:$exe" /link ole32.lib oleaut32.lib comsuppw.lib comdlg32.lib
