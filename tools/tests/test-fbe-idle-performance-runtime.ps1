<# Runs the real Release editor against small and medium fixtures and verifies
...
try {
    ...
    foreach ($case in @(@{ Name = 'small'; Paragraphs = $SmallParagraphCount }, @{ Name = 'medium'; Paragraphs = $MediumParagraphCount })) {
