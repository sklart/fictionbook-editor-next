...
$translations = @{
    ...
    'fbe.dialog.idd_setting_other.nbsp_char' = @{ resource = 'IDD_SETTINGS_EDITOR'; targetId = 'IDC_SETTINGS_OTHER_NBSP_LABEL'; values = @('Display as:','Отображать как:','Відображуваний символ:','Anzuzeigendes Zeichen:','Caractère à afficher :','Carácter mostrado:','Carattere visualizzato:','Wyświetlany znak:','Carácter a apresentar:','Weergegeven teken:','Zobrazovaný znak:','Показван символ:') }
}
