...
if ((Get-Content -Raw -LiteralPath $hta) -match 'loadXML\(xmlDoc\.xml\)') { throw 'Preview не должен сериализовать и повторно разбирать весь FB2.' }
...
try {
 ...
 $largeBinary=('A' * (1024 * 1024))
 $largeBinaries='<binary id="unused-binary-1" content-type="image/png">'+$largeBinary+'</binary><binary id="unused-binary-2" content-type="image/png">'+$largeBinary+'</binary><binary id="unused-binary-3" content-type="image/png">'+$largeBinary+'</binary>'
 @'
<FictionBook xmlns="http://www.gribuser.ru/xml/fictionbook/2.0" xmlns:x="http://www.w3.org/1999/xlink" xmlns:r="http://www.w3.org/1999/xlink"><description><title-info><genre>prose</genre><author><first-name>A</first-name><last-name>B</last-name></author><book-title>Book</book-title><lang>en</lang></title-info><document-info><author><first-name>A</first-name><last-name>B</last-name></author><program-used>x</program-used><date>2026-01-01</date><id>x</id><version>1.0</version></document-info></description><body><section><title><p>Container</p></title><section><title><p>Preview Last</p><p>Split title</p></title><p>text <a x:href="#n1">n</a><a r:href="#c1">c</a></p><image x:href="#pic"/></section></section></body><body name="notes"><section id="n1"><p>note</p></section><section id="unused"><p>unused <a r:href="#unusedc">chain</a></p></section></body><body name="comments"><section id="c1"><p>comment</p></section><section id="unusedc"><p>unused comment</p></section></body><binary id="pic" content-type="image/png">AA==</binary>__LARGE_BINARIES__</FictionBook>
'@.Replace('__LARGE_BINARIES__',$largeBinaries) | Set-Content -LiteralPath $source -Encoding utf8
