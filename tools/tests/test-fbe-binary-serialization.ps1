...
Assert-True ($docSource.Contains('static_cast') -and $docSource.Contains('PutdataType')) 'Production-код обязан снять временный MSXML dataType перед сериализацией.'
