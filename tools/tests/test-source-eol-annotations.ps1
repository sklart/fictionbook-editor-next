...
Assert-Contains $mainFrame 'if \(fv\) \{\s*ClearSourceValidationAnnotations\(\);\s*return 0;' 'annotation clear after successful validation'
...
Assert-Contains $mainFrameHeader 'SC_UPDATE_TEXT\)\s*\r?\n\s*ClearSourceValidationAnnotations\(\)' 'annotation clear after source edit'
