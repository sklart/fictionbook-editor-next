...
if ($source -notmatch 'Outcome::Cancelled' -or $source -notmatch 'Outcome::Failed' -or $source -notmatch 'FbeDiagnostic::HResult\(L"file-dialog"') { throw 'DOCX must distinguish Cancelled and Failed file-dialog outcomes.' }
