...
foreach ($version in @('3.2.0', '3.2.0-beta.1', '3.2.0-rc.10', '3.2.0-alpha.beta', '3.2.0-0.3.7', '3.2.0-x.7.z.92', '3.2.0+build.1', '3.2.0-rc.2+build.42')) {
    if (-not (Test-FbeSemVer $version)) { throw "PowerShell SemVer rejected valid version: $version" }
}
foreach ($version in @('03.2.0', '3.02.0', '3.2.00', '3.2', '3.2.0.1', '3.2.0-', '3.2.0+', '3.2.0-rc.', '3.2.0-.rc', '3.2.0-rc..1', '3.2.0-rc.01', '3.2.0-01', '3.2.0-rc/1', '3.2.0-rc\1', '3.2.0-rc_1', '3.2.0+build..1', '3.2.0+build/')) {
...
if ((Test-FbePrereleaseVersion '3.2.0') -or (Test-FbePrereleaseVersion '3.2.0+build.1') -or -not (Test-FbePrereleaseVersion '3.2.0-beta.1') -or -not (Test-FbePrereleaseVersion '3.2.0-rc.2+build.1')) { throw 'Test-FbePrereleaseVersion contract failed.' }
