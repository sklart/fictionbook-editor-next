...
Assert-Contains $scintilla "Get-EditorDependencyVersion" "build-scintilla.ps1: current editor dependency versions"
Assert-Contains $scintilla '$fingerprint.scintillaVersion -ne $scintillaVersion' "build-scintilla.ps1: Scintilla version fingerprint"
Assert-Contains $scintilla '$fingerprint.lexillaVersion -ne $lexillaVersion' "build-scintilla.ps1: Lexilla version fingerprint"
