...
foreach ($test in @('test-release-test-catalog.ps1', 'test-fb2-common-boundary.ps1', 'test-first-party-msbuild-policy.ps1', 'test-fbe-contract-generation.ps1', 'test-fbe-plugin-host-boundary.ps1', 'test-fbe-source-helpers-boundary.ps1', 'test-fbe-search-boundary.ps1', 'test-fbe-settings-background-boundary.ps1', 'test-package-layout.ps1', 'test-release-artifact-cleanup.ps1', 'test-package-layout-copy.ps1', 'test-package-layout-integration-stage.ps1', 'test-package-layout-core-stage.ps1', 'test-fbe-table-visual-mode.ps1', 'test-table-toolbar-contract.ps1', 'test-fbe-script-document-path-api.ps1', 'test-fbe-backup-settings.ps1', 'test-fbe-auto-url-detect.ps1', 'test-xml-source-themes.ps1', 'test-xml-source-current-line.ps1', 'test-fbe-filename-state.ps1', 'test-fbe-source-xml-declaration.ps1')) { Require $verify $test 'verify-release FAST contour' }
