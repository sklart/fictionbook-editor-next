...
Assert-Contains $workflow "Write Modern build provenance" "Modern profile provenance перед verify"
Assert-Contains $workflow "-Kind Modern -Configuration Release -ProfileDirectory out/editor-runtime/Modern -BatchDirectory out/target-batches/Modern" "Modern profile provenance inputs"
Assert-Contains $workflow "Write Win7 build provenance" "Win7 profile provenance перед verify"
Assert-Contains $workflow "-Kind Win7 -Configuration Release -ProfileDirectory out/editor-runtime/Win7 -BatchDirectory out/target-batches/Win7" "Win7 profile provenance inputs"
