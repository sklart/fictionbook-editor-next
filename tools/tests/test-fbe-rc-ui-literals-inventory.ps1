...
foreach ($generatedDialog in @("IDD_TABLE", "IDD_INPUTBOX", "IDD_ADDIMAGE", "IDD_TOOLS_SETTINGS", "IDD_ABOUTBOX", "IDD_CUSTOMSAVEDLG", "IDD_SETTINGS_WORDS", "IDD_HOTKEYS", "IDD_FIND", "IDD_REPLACE", "IDD_SPELL_CHECK", "IDD_WORDS", "IDD_SETTING_OTHER", "IDD_SETTINGS_SOURCE", "IDD_OPTIONS")) {
