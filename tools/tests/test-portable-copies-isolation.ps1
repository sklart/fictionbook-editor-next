...
$invalid = Get-PortablePaths (New-PortableCopy 'InvalidOverride' '..\escape')
...
if (-not $invalid.dataRoot.EndsWith('\InvalidOverride\Data\')) { throw 'Unsafe DataPath did not fall back to Data.' }
