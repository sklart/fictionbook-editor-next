...
Assert-Contains $pane 'LVS_SINGLESEL' 'Results pane keeps exactly one selected row'
Assert-Contains $pane 'LVS_SHOWSELALWAYS' 'keyboard-selected row remains visible when the pane loses focus'
