...
Must $settings 'migratedLegacyScriptHotkey' 'Legacy absolute Hotkeys.xml migration'
Must $settings 'relativePath\.Replace\(L.\\\\.\s*,\s*L./.' 'Legacy hotkey migration normalizes separators'
