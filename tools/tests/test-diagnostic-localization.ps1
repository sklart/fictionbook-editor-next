...
$keys = @('fbe.menu.idr_mainframe.tools.open_diagnostic_log','fbe.menu.idr_mainframe.tools.open_diagnostic_folder','fbe.menu.idr_mainframe.tools.copy_diagnostic_log_path','fbe.menu.idr_mainframe.tools.clear_diagnostic_logs','fbe.trace.clear_confirmation','fbe.trace.clear_completed','fbe.trace.clear_failed','fbe.trace.clear_completed_details','fbe.trace.clear_partial','fbe.trace.clear_empty','fbe.trace.clear_delete_failed','fbe.trace.open_folder_failed','fbe.trace.copy_path_failed')
foreach($key in $keys) {
