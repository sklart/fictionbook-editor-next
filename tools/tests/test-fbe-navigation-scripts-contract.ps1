...
Must $documentTree 'm_mode_button\.SetButtonSize\(extent, extent\)' 'mode button is square and never exceeds the title-bar height'
Must $documentTree 'SetWindowPos\(NULL, left, top, extent, extent' 'mode button window uses the same square extent'
...
Must $documentTreeHeader 'IsStructuralToolbarVisible' 'runtime test can verify structural toolbar visibility by mode'
