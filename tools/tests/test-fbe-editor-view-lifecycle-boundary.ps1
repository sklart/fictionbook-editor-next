...
if($mainSource -notmatch 'MakeEditorViewTransitionPlan' -or $mainSource -notmatch 'NextEditorView') { throw 'CMainFrame does not coordinate the extracted view lifecycle.' }
