...
$utils = Text 'src\fbe\utils\Utils.cpp'; Has $utils 'GetProgDir() + L"defaults\\" + filename' 'Built-in user-data defaults'; Has $utils 'GetSettingsDir() + filename' 'User data destination'
