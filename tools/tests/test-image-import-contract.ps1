...
Assert-True ($importSource -match '254\.0 / 255\.0' -and $importSource -match 'value / \(value \+ 0\.10\)') 'HDR tone mapping должен иметь bounded shoulder без массового клиппинга в 255.'
