...
int wmain()
{
    ...
    const wchar_t* invalid[] = { L"3", L"3.1", L"3.1.", L"v3.1.0", L"3.1.0-", L"3.1.0.+build.1", L"3.1.0-rc.+build.1", L"3.1.0-rc..1+build.1", L"3.1.0-rc..1", L"3.1.0-rc.01", L"3.1.0-01", L"03.1.0", L"3.01.0", L"3.1.00" };
