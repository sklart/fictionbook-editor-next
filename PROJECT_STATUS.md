...
Текущая версия продукта: `3.0.5` (выпущена 15 июля 2026 года).
...
- Документы записываются через временный файл и замену Windows API; создание
  `.bak` при перезаписи настраивается на вкладке «FBE Next» и включено по
  умолчанию.
...
- `update.xml` содержит версию `3.0.5`, дату `15-07-2026`, `Beta=false`, URL setup и SHA-256.
...
- Продукт: FictionBook Editor 3.0.5.
