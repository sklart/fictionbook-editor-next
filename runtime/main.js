...
function GetBodyCommandState(cp, insideCode, insideSpan)
{
  var state = 0;
  ...
  put(16, StyleTextAuthor(cp,true)); put(32, InsImage(true) && !insideCode && !insideSpan);
  put(64, InsInlineImage(true)); put(128, AddImage(cp,true) && !insideCode && !insideSpan);
