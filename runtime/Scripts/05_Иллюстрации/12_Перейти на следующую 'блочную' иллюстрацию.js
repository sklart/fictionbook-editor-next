// Скрипт "Перейти на следующую блочную иллюстрацию" для редактора FBE
// version 1.2
// Идея - TaKir
// Реализация - DeepSeek, TaKir

// Скрипт предназначен для поиска и выделения следующей "блочной" (отдельностоящей) иллюстрации в fb2 документе.
...
// На основе скрипта "Выделить следующий любой структурный элемент" ver. 2.8
...
function Run() {
    ...
    var scriptName = "Перейти на следующую блочную иллюстрацию";
    var version = "1.2";
    ...
    try { window.external.SetStatusBarText("Ищем следующую иллюстрацию..."); } catch(e) {}
   ...
   // Если нашли иллюстрацию, выделяем её
    if (foundImage) {
        ...
        MsgBox(scriptName + "\nver. " + version + "\n\n" +
               "До конца документа не нашлось ни одной блочной иллюстрации.");
    }
