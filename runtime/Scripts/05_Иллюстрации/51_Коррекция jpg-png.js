...
window.external.BeginUndoUnit(document,"«Коррекция jpg/png» v."+NumerusVersion);           // начало записи в систему отмен
...
// -----------------------------
 ...
 var d=0;
 var dm=false;
 if (VseStroki_on_off == 1)  { d="показать нули"; dm=true }
...
// -----------------------------
 ...
 var ind=0;        //  Номер строки
                                                 ...
                                                 mSt[ind]="                                 –= ◊ =–";  ind++;
                                                 mSt[ind]="          . . . «Коррекция jpg/png» v."+NumerusVersion+" . . .";  ind++;
                                                 mSt[ind]="       ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍ ̍";  ind++;
                                                 mSt[ind]="						  ";  ind++;
 ...
 if (count_Img_noBin!=d) {
         if (count_Img_noBin == count_Img_noBin2  ||  dm) {
 ...
 if (cTaT==ind-2) {
         ind=ind-1;
                                                 mSt[ind]="";  ind++;
                                                 mSt[ind]=">> Исправлений нет";  ind++; }   //  добавление этой строки, если нет пунктов с исправлениями
