...
//  Скрипт предназначен для массовой расстановки иллюстраций в началах и концах секций fb2 документа.
...
function showStatistics(stats) {
    ...
    var message = "Скрипт «Вставить ссылки на пустые картинки в началах и концах секций» v3.7\n\n";
