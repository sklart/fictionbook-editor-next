// Скрипт "Перейти на следующую битую или ошибочную блочную иллюстрацию" для редактора FBE
// version 1.0
// Идея - TaKir
// Реализация - DeepSeek, TaKir

// Скрипт предназначен для поиска и выделения следующей "битой или ошибочной" блочной (отдельностоящей) иллюстрации
...
function Run() {
    ...
    var scriptName = "Перейти на следующую битую или ошибочную блочную иллюстрацию";
    var version = "1.0";
    ...
    try { window.external.SetStatusBarText("Ищем следующую битую или ошибочную иллюстрацию..."); } catch(e) {}
    ...
    // === АЛГОРИТМ ПОИСКА БИТЫХ И ОШИБОЧНЫХ ИЛЛЮСТРАЦИЙ ===
    ...
    // Поиск следующей битой или ошибочной иллюстрации
    ...
    if (foundImage) {
        ...
        MsgBox(scriptName + "\nver. " + version + "\n\n" +
               "До конца документа не нашлось ни одной битой или ошибочной блочной иллюстрации.");
    }
