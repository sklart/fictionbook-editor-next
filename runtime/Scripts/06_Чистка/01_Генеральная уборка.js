...
//======================================
//v.2.9 — регэкспы (п.п. 157-164) — TaKir
//======================================
...
//        if (count_130!=0)   {st2+='\n• Унификация закрывающих болдов и курсивов:	'+count_130;}
 ...
 if (count_159!=0)   {st2+='\n• Замена кавычек в названии изд-ва:	'+count_159;}
 if (count_160!=0)   {st2+='\n• Замена символа U+E098 после гласной на гласную с ударением:	'+count_160;}
 if (count_161!=0)   {st2+='\n• Замена цифры 2 внутри слова после гласной на гласную с ударением:	'+count_161;}
 if (count_162!=0)   {st2+='\n• Замена ударений-апострофов после строчной гласной на гласную с ударением:	'+count_162;}
