// Скрипт «Поиск возможных МНОЖЕСТВЕННЫХ маркеров сносок в квадратных скобках» для редактора Fiction Book Editor (FBE).
// Основано на скрипте «Поиск по набору регэкспов»
// Версия 5.3

// Автор Sclex, набор RegExp-ов - TaKir, Sclex, 18.04.2026
...
// 18 апреля 2026 добавлены поисковые строки для множественных знаков сносок в квадратных скобках (TaKir)

// Скрипт предназначен для поиска возможных типичных МНОЖЕСТВЕННЫХ маркеров знаков сносок (МЗС) в fb2 документах.
...
// Обновленный набор регэкспов от 18.04.2026 (TaKir)
//======================================
...
// -------------начало блока TaKir - регэкспы (18.04.2026)---------------

// Ищем только СДВОЕННЫЕ или МНОЖЕСТВЕННЫЕ маркеры знаков сносок МЗС в квадратных скобках (всякий научпоп)

// Пример: текст [37, 21 et 68], [107, 117–142] текст ▫[28, IV, App. 223], текст [38], [67,48] текст

  addRegExp("(?:\\[\\s*(?=[^\\]]*\\d)[^\\[\\]]+?\\s*\\](?:[\\s\\u00A0]*|\\s*,\\s*))+(?:\\[\\s*(?=[^\\]]*\\d)[^\\[\\]]+?\\s*\\])|\\[\\s*(?=[^\\]]*\\d)[^\\[\\]]*?(?:[^\\d\\s]|\\d+\\s*[,\\-–]|\\d+\\s+\\d)[^\\[\\]]*?\\s*\\]","","Найдено: №2 множественные ссылки в квадратных скобках (цепочки или одиночные сложные)");


// Одиночные маркеры сносок типа [64] скрипт пропускает!

// ======= Если надо искать и одиночные числа в квадратных скобках - раскомментируйте строку ниже =======:

// addRegExp("\\[\\s*(\\d{1,5})\\s*\\]","","Найдено: одиночные числа в квадратных скобках");


// -------------конец блока TaKir - регэкспы (18.04.2026):---------------
