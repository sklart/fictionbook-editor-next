// Скрипт «Заменить прилипшие к тексту цифры на знак решетки (#) в выделенном фрагменте» для редактора FBE 
// version 5.0
// Идея - TaKir
// Реализация - DeepSeek, TaKir

// Скрипт предназначен для расстановки возможных маркеров сносок,
// выполненных «прилипшими» цифрами, в выделенном фрагменте в fb2 документах.
...
// version 5.0, 28.11.2025
//======================================

function Run() {
    try {
        var scriptName = "Заменить прилипшие к тексту цифры на # в выделенном фрагменте";
        ...
        // Используем подход с маркерами как в поисковом скрипте
        var MyTagName = "B";
        ...
        // Устанавливаем маркеры начала и конца выделения
        ...
        var ptr = el;
        var BlockStartNode, BlockEndNode;
        ...
        while (!processingEnded) {
            ...
            // Если находимся внутри выделения - обрабатываем текстовые узлы
            if (insideSelection && ptr.nodeType == 3) {
                processTextNode(ptr);
            }
            
            // Переходим к следующему узлу
            var nextPtr = getNextNode(ptr);
            if (!nextPtr || nextPtr == body) break;
            ptr = nextPtr;
        }
        
        // Восстанавливаем выделение и удаляем маркеры
        ...
        // Функция перехода к следующему узлу
        ...
        message += "\nОбработан только выделенный фрагмент.";
