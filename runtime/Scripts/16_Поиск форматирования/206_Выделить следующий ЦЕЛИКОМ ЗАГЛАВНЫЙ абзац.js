// Скрипт «Выделить следующий ЦЕЛИКОМ ЗАГЛАВНЫЙ абзац» для редактора Fiction Book Editor (FBE).
// Идея и набор регэкспов - TaKir
// version 1.0

// Основано на скрипте "Поиск по набору регэкспов" (версии 5.1)
// Автор исходного скрипта: Sclex

// Скрипт предназначен для обнаружения (вниз по тексту от места курсора)
// и выделения ближайшего найденного абзаца,
// целиком набранного ЗАГЛАВНЫМИ буквами (2 и более ЗАГЛАВНЫХ букв) .
//  Обрабатываются русский + расширенная латиница и греческий.
...
function Run() {
 ...
 // -------------начало блока TaKir - регэкспы (TaKir, 31.03.2026)---------------

    addRegExp("^[^a-zà-öø-ÿа-яёA-ZÀ-ÖØ-ÝА-ЯЁ]*([A-ZÀ-ÖØ-ÝА-ЯЁ][^a-zà-öø-ÿа-яёA-ZÀ-ÖØ-ÝА-ЯЁ]*){2,}$","","Найдено: абзац ЦЕЛИКОМ ЗАГЛАВНЫМИ БУКВАМИ (русский + расширенная латиница)","-annotation -title -epigraph -cite -stanza -poem -subtitle");

  addRegExp("^[^a-zа-яёα-ωA-ZА-ЯЁΑ-Ω]*([Α-Ω][^a-zа-яёα-ωA-ZА-ЯЁΑ-Ω]*){2,}$","","Найдено: абзац ЦЕЛИКОМ ЗАГЛАВНЫМИ БУКВАМИ (греческий)","-annotation -title -epigraph -cite -stanza -poem -subtitle");

   // если надо искать везде, без ограничений - то раскомментировать и использовать эти строки:

   // addRegExp("^[^a-zà-öø-ÿа-яёA-ZÀ-ÖØ-ÝА-ЯЁ]*([A-ZÀ-ÖØ-ÝА-ЯЁ][^a-zà-öø-ÿа-яёA-ZÀ-ÖØ-ÝА-ЯЁ]*){2,}$","","Найдено: абзац ЦЕЛИКОМ ЗАГЛАВНЫМИ БУКВАМИ (русский + расширенная латиница)","");

   // addRegExp("^[^a-zа-яёα-ωA-ZА-ЯЁΑ-Ω]*([Α-Ω][^a-zа-яёα-ωA-ZА-ЯЁΑ-Ω]*){2,}$","","Найдено: абзац ЦЕЛИКОМ ЗАГЛАВНЫМИ БУКВАМИ (греческий)","");

// -------------конец блока TaKir - регэкспы (TaKir, 31.03.2026)---------------
