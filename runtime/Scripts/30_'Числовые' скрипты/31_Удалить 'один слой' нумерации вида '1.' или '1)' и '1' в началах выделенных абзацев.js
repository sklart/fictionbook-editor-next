// Скрипт "Удалить 'один слой' нумерации вида '1.', '1)' и '1' в началах выделенных абзацев"
// version 1.4
// Автор - Sclex
// Доработка - TaKir, DeepSeek

// version 1.4, 27.12.2025
// Добавлена обработка нумерации без точек и скобок (TaKir)
//======================================
...
function Run() {
 ...
 // Изменено регулярное выражение: добавлена возможность отсутствия точки/скобки после цифр
 ...
 // Изменено регулярное выражение: точка/скобка теперь необязательны
 ...
 window.external.BeginUndoUnit(document,"удаление 'одного слоя' нумерации вида '1.', '1)' и '1' в началах выделенных абзацев");
 try { window.external.SetStatusBarText("Удаляем 'один слой' нумерации вида '1.', '1)' и '1' в началах выделенных абзацев..."); }
 catch(e) {}
