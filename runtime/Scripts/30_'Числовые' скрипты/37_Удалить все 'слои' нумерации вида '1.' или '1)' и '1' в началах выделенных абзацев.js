//скрипт «Удалить все 'слои' нумерации вида "1.", "1)" и "1" в началах выделенных абзацев»
// version 1.4
// Автор - Sclex
...
//     alert("Будем заменять вот на что:\n\n"+pInnerHTML);
 ...
 window.external.BeginUndoUnit(document,"удаление всех 'слоев' нумерации вида '1.', '1)' и '1' в началах выделенных абзацев");
 try { window.external.SetStatusBarText("Удаляем все 'слои' нумерации вида '1.', '1)' и '1' в началах выделенных абзацев..."); }
 catch(e) {}
