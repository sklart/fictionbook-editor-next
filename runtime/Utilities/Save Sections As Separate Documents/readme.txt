...
Рекомендуемый основной вариант для современных систем: SaveSectionsAsSeparateDocuments.hta (теперь это версия на MSXML6).

В вашей системе могут корректно работать все четыре версии программы, а может - только какая-то одна.
_____________________________________________________________________________
