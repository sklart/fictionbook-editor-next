...
namespace AU
{
	...
	// После перехода проекта на PCRE2 в живой сборке остаётся только наш
	// VBScript-совместимый wrapper поверх внутреннего regex-backend.
