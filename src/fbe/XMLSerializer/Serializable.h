...
public:
	...
	CProperty(IObjectFactory* factory = NULL) : m_type(Blank), m_object(NULL), m_factory(factory) { }

	CProperty(const CString& sName) : m_sDefValue(), m_type(Blank), m_sName(sName), m_object(NULL), m_factory(NULL) { }

	CProperty(const CString& sName, const CString& sValue) : m_type(Simple), m_sName(sName), m_sValue(sValue), m_object(NULL), m_factory(NULL) { }

	CProperty(const CString& sName, ISerializable* object) : m_type(Complex), m_sName(sName), m_object(object), m_factory(NULL) { }
