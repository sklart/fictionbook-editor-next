...
public:
  ...
  CMainFrame() : m_doc(0), m_last_tree_update(0), m_last_sci_ovr(true), m_last_ie_ovr(true),
    ...
    m_recovery_written(false), m_current_dpi(96), m_saved_xml(0), m_cb_updated(false),
...
/*    return m_doc->m_desc==m_view.GetActiveWnd() ?
  ...
  void	  SetSciStyles();
	...
	BEGIN_UPDATE_UI_MAP(CMainFrame)
		...
		UPDATE_ELEMENT(ID_TABLE_INSERT_ROW_ABOVE, UPDUI_MENUPOPUP)
		UPDATE_ELEMENT(ID_TABLE_INSERT_ROW_BELOW, UPDUI_MENUPOPUP)
		UPDATE_ELEMENT(ID_TABLE_DELETE_ROW, UPDUI_MENUPOPUP)
		UPDATE_ELEMENT(ID_TABLE_INSERT_COLUMN_LEFT, UPDUI_MENUPOPUP)
		UPDATE_ELEMENT(ID_TABLE_INSERT_COLUMN_RIGHT, UPDUI_MENUPOPUP)
		UPDATE_ELEMENT(ID_TABLE_DELETE_COLUMN, UPDUI_MENUPOPUP)
		UPDATE_ELEMENT(ID_TABLE_TOGGLE_HEADER_CELL, UPDUI_MENUPOPUP)
		UPDATE_ELEMENT(ID_TABLE_MAKE_HEADER_CELLS, UPDUI_MENUPOPUP)
		UPDATE_ELEMENT(ID_TABLE_MAKE_NORMAL_CELLS, UPDUI_MENUPOPUP)
