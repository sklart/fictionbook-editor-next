...
echo Building ExportDOCX and ExportDOCXBatch: Release ^| Win32
echo "%MSBUILD%" "%SLN%" /m /t:Rebuild /p:Configuration=Release /p:Platform=Win32
"%MSBUILD%" "%SLN%" /m /t:Rebuild /p:Configuration=Release /p:Platform=Win32
if errorlevel 1 (
  echo.
  echo Build failed.
  pause
...
if exist "%~dp0out\Win32\Release\ExportDOCX.dll" echo   %~dp0out\Win32\Release\ExportDOCX.dll
if exist "%~dp0out\Win32\Release\ExportDOCXBatch.exe" echo   %~dp0out\Win32\Release\ExportDOCXBatch.exe
pause
