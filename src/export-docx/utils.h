...
namespace U { // place all utilities into their own namespace
  ...
  public:
    ...
    // PVS-Studio: BEGIN_COM_MAP expands to ATL-generated COM infrastructure.
    // V835/V1096 are false positives here; COM signatures and ATL inline static tables are intentional.
    //-V835
    //-V1096
    BEGIN_COM_MAP(HandleStreamImpl) //-V835 //-V835 //-V1096
