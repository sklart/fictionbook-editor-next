...
- Локализация из ресурсов вынесена в json-файлы, что позволит сторонним переводчикам легко вносить свои правки, а также позднее подключить переводы к веб-инстурментам перевода типа Weblate.
