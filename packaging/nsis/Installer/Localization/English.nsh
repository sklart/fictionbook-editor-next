...
LangString InstallScopeConflict ${LANG_ENGLISH} "FictionBook Editor Next is already installed for the other scope. Remove or upgrade that installation first, then run this setup again. Your settings will not be removed."
