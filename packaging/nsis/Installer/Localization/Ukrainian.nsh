...
LangString UacAbortInstaller ${LANG_UKRAINIAN} "Встановлення для всіх користувачів або системна інтеграція потребує прав адміністратора. Встановлення буде перервано."
