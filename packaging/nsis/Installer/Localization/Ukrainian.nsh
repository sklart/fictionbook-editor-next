...
LangString InstallScopeCurrent ${LANG_UKRAINIAN} "Лише для мене (рекомендовано) — без прав адміністратора"
LangString InstallScopeAllUsers ${LANG_UKRAINIAN} "Для всіх користувачів — потрібні права адміністратора"
LangString InstallScopeConflict ${LANG_UKRAINIAN} "Щоб змінити область встановлення, спочатку видаліть наявну копію FictionBook Editor Next, а потім знову запустіть цей інсталятор. Користувацькі налаштування буде збережено."
LangString InvalidDeploymentCommandLine ${LANG_UKRAINIAN} "Використовуйте лише один параметр режиму: /CURRENTUSER, /ALLUSERS або /PORTABLE."
...
LangString UacRetryInstaller ${LANG_UKRAINIAN} "Для встановлення для всіх користувачів або системної інтеграції потрібні права адміністратора. Повторити запит на підвищення прав?"
LangString UacAbortInstaller ${LANG_UKRAINIAN} "Встановлення для всіх користувачів або системна інтеграція потребує прав адміністратора. Встановлення буде прервана."
...
; uninstall messages
LangString UninstUserDataTitle ${LANG_UKRAINIAN} "Дані користувача"
LangString UninstUserDataCheckbox ${LANG_UKRAINIAN} "Видалити налаштування та дані поточного користувача"
